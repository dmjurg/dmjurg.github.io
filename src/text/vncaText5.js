export const vncaText5 = [
  {
    title: `§ 13.1-829. Corporate name.`,
    text: [
      `A. A corporate name shall not contain:
     1. Any word or phrase that indicates or implies that it is organized for the purpose of conducting any business other than a business which it is authorized to conduct;
     2. The word "redevelopment" unless the corporation is organized as an urban redevelopment corporation pursuant to Chapter 190 of the 1946 Acts of Assembly, as amended;
     3. Any word, abbreviation, or combination of characters that states or implies the corporation is a limited liability company or a limited partnership; or
  ...
  {
    title: `§ 13.1-831. Registered name.`,
    text: [
      `A. A foreign corporation may register its corporate name, or its corporate name with any addition required by § 13.1-924, if the name is distinguishable upon the records of the Commission from the corporate names that are not available under subsection B of § 13.1-829.
     B. A foreign corporation registers its corporate name, or its corporate name with any addition required by § 13.1-924, by:
     1. Filing with the Commission (i) an application setting forth its corporate name, or its corporate name with any addition required by § 13.1-924, the state or country and date of its incorporation, and a brief description of the nature of the business in which it is engaged; and (ii) a certificate setting forth that such corporation is in good standing, or a document of similar import, from the state or country of incorporation, executed by the official who has custody of the records pertaining to corporations; and
     2. Paying to the Commission a registration fee in the amount of $20. Except as provided in subsection E, registration is effective for one year after the date an application is filed.
