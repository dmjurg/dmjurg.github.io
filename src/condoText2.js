export const condoText2 = [
  {
    title: `§ 55-79.45. How condominium may be created.`,
    text:
      `
  ...
  {
    title: `§ 55-79.47. Description of condominium units.`,
    text:
      `
  ...
  {
    title: `§ 55-79.48. Execution of condominium instruments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.49. Recordation of condominium instruments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.50. Construction of condominium instruments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.51. Complementarity of condominium instruments; controlling construction.`,
    text:
      `
  ...
  {
    title: `§ 55-79.52. Validity of condominium instruments; discrimination prohibited.`,
    text:
      `
  ...
  {
    title: `§ 55-79.53. Compliance with condominium instruments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.54. Contents of declaration.`,
    text:
      `
        ...
        (3) A legal description by metes and bounds of the land submitted to this chapter.
        ...
        (5) A description or delineation of any limited common elements, other than those which are limited common elements by virtue of subsection (e) of § 55-79.50, showing or designating the unit or units to which each is assigned.
        ...
        (7) The allocation to each unit of an undivided interest in the common elements in accordance with the provisions of § 55-79.55.
        ...
        (3) A statement, with respect to each such convertible land, of the maximum percentage of the aggregate land and floor area of all units that may be created therein that may be occupied by units not restricted exclusively to residential use.
        ...
        (6) A statement that any units created within each convertible land will be substantially identical to the units on other portions of the submitted land, or a statement describing in detail what other types of units may be created therein.

        (7) A description of the declarant's reserved right, if any, to create limited common elements within any convertible land, and/or to designate common elements therein which may subsequently be assigned as limited common elements, in terms of the types, sizes, and maximum number of such elements within each such convertible land.

        Provided, that plats and plans may be recorded with the declaration and identified therein to supplement information furnished pursuant to items (1), (4), (5), (6), and (7), and that item (3) need not be complied with if none of the units on other portions of the submitted land are restricted exclusively to residential use.
        ...
        (3) A time limit, not exceeding 10 years from the recording of the declaration, upon which the option to expand the condominium shall expire, together with a statement of the circumstances, if any, which will terminate that option prior to the expiration of the time limit so specified. After the expiration of any period of declarant control reserved pursuant to subsection A of § 55-79.74, such time limit may be extended by an amendment to the declaration made pursuant to § 55-79.71.
        ...
        (8) A statement of the maximum number of units that may be created on the additional land. If portions of the additional land may be added to the condominium and the boundaries of those portions are fixed in accordance with item (6), the declaration shall also state the maximum number of units that may be created on each such portion added to the condominium. If portions of the additional land may be added to the condominium and the boundaries of those portions are not fixed in accordance with item (6), then the declaration shall also state the maximum number of units per acre that may be created on any such portion added to the condominium.
        ...
        (11) A description of all other improvements that will be made on any portion of the additional land added to the condominium, or a statement of any limitations as to what other improvements may be made thereon, or a statement that no assurances are made in that regard.
        ...
        Provided, that plats and plans may be recorded with the declaration and identified therein to supplement information furnished pursuant to items (4), (5), (6), (7), (10), (11), (12), and (13), and that item (9) need not be complied with if none of the units on the submitted land are restricted exclusively to residential use.
        ...
        (3) A time limit, not exceeding 10 years from the recording of the declaration, upon which the option to contract the condominium shall expire, together with a statement of the circumstances, if any, which will terminate that option prior to the expiration of the time limit so specified.

        (4) A legal description by metes and bounds of all land that may be withdrawn from the condominium, henceforth referred to as "withdrawable land."

        (5) A statement as to whether portions of the withdrawable land may be withdrawn from the condominium at different times, together with any limitations fixing the boundaries of those portions by legal descriptions setting forth the metes and bounds thereof and/or regulating the order in which they may be withdrawn from the condominium.

        (6) A legal description by metes and bounds of all of the submitted land to which the option to contract the condominium does not extend.

        Provided, that plats may be recorded with the declaration and identified therein to supplement information furnished pursuant to items (4), (5), and (6), and that item (6) shall not be construed in derogation of any right the declarant may have to terminate the condominium in accordance with the provisions of § 55-79.72:1.
        ...
        (f) Wherever this section requires a legal description by metes and bounds of land that is submitted to this chapter or that may be added to or withdrawn from the condominium, such requirement shall be deemed satisfied by any legally sufficient description and shall be deemed to require a legally sufficient description of any easements that are submitted to this chapter or that may be added to or withdrawn from the condominium, as the case may be. In the case of each such easement, the declaration shall contain the following:
        ...
        (3) If any persons other than those entitled to the use of the units may utilize such easement, a statement of the rights of others to utilization of the same.
  ...
  {
    title: `§ 55-79.55. Allocation of interests in the common elements.`,
    text:
      `
        (a) The declaration may allocate to each unit depicted on plats and plans that comply with subsections A and B of § 55-79.58 an undivided interest in the common elements proportionate to either the size or par value of each unit.
        ...
        (c) The undivided interests in the common elements allocated in accordance with subsection (a) or (b) hereof shall add up to 1 if stated as fractions or 100% if stated as percentages.

        (d) If, in accordance with subsection (a) or (b) hereof, an equal undivided interest in the common elements is allocated to each unit, the declaration may simply state that fact and need not express the fraction or percentage so allocated.

        (e) Otherwise, the undivided interest allocated to each unit in accordance with subsection (a) or (b) hereof shall be reflected by a table in the declaration, or by an exhibit or schedule accompanying the declaration and recorded simultaneously therewith, containing three columns. The first column shall identify the units, listing them serially or grouping them together in the case of units to which identical undivided interests are allocated. Corresponding figures in the second and third columns shall set forth the respective areas or par values of those units and the fraction or percentage of undivided interest in the common elements allocated thereto.
  ...
  {
    title: `§ 55-79.56. Reallocation of interests in common elements.`,
    text:
      `
        ...
        (1) Prohibits the creation of any units not substantially identical to the units depicted on the plats and plans recorded pursuant to subsections A and B of § 55-79.58, or
  ...
  {
    title: `§ 55-79.57. Assignments of limited common elements; conversion to common element.`,
    text:
      `
        ...
        B. Unless expressly prohibited by the condominium instruments, a limited common element may be reassigned or converted to a common element upon written application of the unit owners concerned to the principal officer of the unit owners' association, or to such other officer or officers as the condominium instruments may specify. The officer or officers to whom such application is duly made shall forthwith prepare and execute an amendment to the declaration reassigning all rights and obligations with respect to the limited common element involved. Such amendment shall be executed by the unit owner or unit owners of the unit or units concerned and recorded by an officer of the unit owners' association or his agent following payment by the unit owner or unit owners of the unit or units concerned of all reasonable costs for the preparation, acknowledgment and recordation thereof. The amendment shall become effective when recorded.

        C. A common element not previously assigned as a limited common element shall be so assigned only in pursuance of subdivision (a) (6) of § 55-79.54. The amendment to the declaration making such an assignment shall be prepared and executed by the declarant, the principal officer of the unit owners' association, or by such other officer or officers as the condominium instruments may specify. Such amendment shall be recorded by the declarant or his agent, without charge to any unit owner, or by an officer of the unit owners' association or his agent following payment by the unit owner or unit owners of the unit or units concerned of all reasonable costs for the preparation, acknowledgment and recordation thereof. The amendment shall become effective when recorded, and the recordation thereof shall be conclusive evidence that the method prescribed pursuant to subdivision (a) (6) of § 55-79.54 was adhered to. A copy of the amendment shall be delivered to the unit owner or unit owners of the unit or units concerned. If executed by the declarant, such an amendment recorded prior to July 1, 1983, shall not be invalid because it was not prepared by an officer of the unit owners' association.
  ...
  {
    title: `§ 55-79.58. Contents of plats and plans.`,
    text:
      `
        A. There shall be recorded simultaneously with the declaration one or more plats of survey showing the location and dimensions of the submitted land, the location and dimensions of any convertible lands within the submitted land, the location and dimensions of any existing improvements, the intended location and dimensions of any contemplated improvements which are to be located on any portion of the submitted land other than within the boundaries of any convertible lands, and, to the extent feasible, the location and dimensions of all easements appurtenant to the submitted land or otherwise submitted to this chapter as a part of the common elements. If the submitted land is not contiguous, then the plats shall indicate the distances between the parcels constituting the submitted land. The plats shall label every convertible land as a convertible land, and if there is more than one such land the plats shall label each such land with one or more letters and/or numbers different from those designating any other convertible land and different also from the identifying number of any unit. The plats shall show the location and dimensions of any withdrawable lands, and shall label each such land as a withdrawable land. The plats shall show the location and dimensions of any additional lands and shall label each such land as an additional land. If, with respect to any portion or portions, but less than all, of the submitted land, the unit owners are to own only an estate for years, the plats shall show the location and dimensions of any such portions, and shall label each such portion as a leased land. If there is more than one withdrawable land, or more than one leased land, the plats shall label each such land with one or more letters and/or numbers different from those designating any convertible land or other withdrawable or leased land, and different also from the identifying number of any unit. The plats shall show all easements to which the submitted land or any portion thereof is subject, and shall show the location and dimensions of all such easements to the extent feasible. The plats shall also show all encroachments by or on any portion of the condominium. In the case of any improvements located or to be located on any portion of the submitted land other than within the boundaries of any convertible lands, the plats shall indicate which, if any, have not been begun by the use of the phrase "(NOT YET BEGUN)," and which, if any, have been begun but have not been substantially completed by the use of the phrase "(NOT YET COMPLETED)." In the case of any units the vertical boundaries of which lie wholly or partially outside of structures for which plans pursuant to subsection B are simultaneously recorded, the plats shall show the location and dimensions of such vertical boundaries to the extent that they are not shown on such plans, and the units or portions thereof thus depicted shall bear their identifying numbers. Each plat shall be certified in a recorded document as to its accuracy and compliance with the provisions of this subsection by a licensed land surveyor, and the said surveyor shall certify in such document or on the face of the plat that all units or portions thereof depicted thereon pursuant to the preceding sentence of this subsection have been substantially completed. The specification within this subsection of items that shall be shown on the plats shall not be construed to mean that the plats shall not also show all other items customarily shown or hereafter required for land title surveys.

        B. There shall also be recorded, simultaneously with the declaration, plans of every structure which contains or constitutes all or part of any unit or units, and which is located on any portion of the submitted land other than within the boundaries of any convertible lands. The plans shall show the location and dimensions of the vertical boundaries of each unit to the extent that such boundaries lie within or coincide with the boundaries of such structures, and the units or portions thereof thus depicted shall bear their identifying numbers. In addition, each convertible space thus depicted shall be labeled a convertible space. The horizontal boundaries of each unit having horizontal boundaries shall be identified on the plans with reference to established datum. Unless the condominium instruments expressly provide otherwise, it shall be presumed that in the case of any unit not wholly contained within or constituting one or more such structures, the horizontal boundaries thus identified extend, in the case of each such unit, at the same elevation with regard to any part of such unit, lying outside of such structures, subject to the following exception: In the case of any such unit which does not lie over any other unit other than basement units, it shall be presumed that the lower horizontal boundary, if any, of that unit lies at the level of the ground with regard to any part of that unit lying outside of such structures. The plans shall be certified on their face or in another recorded document as to their accuracy and compliance with the provisions of this subsection by a licensed architect, licensed engineer or licensed land surveyor, and the said architect, engineer or land surveyor shall certify on the plans or in the recorded document that all units or portions thereof depicted thereon have been substantially completed.

        C. When converting all or any portion of any convertible land, or adding additional land to an expandable condominium, the declarant shall record, with regard to any structures on the land being converted, or added, either plats of survey conforming to the requirements of subsection A and plans conforming to the requirements of subsection B, or certifications, conforming to the certification requirements of said subsections, of plats and plans previously recorded pursuant to § 55-79.59.

        D. Notwithstanding the provisions of subsection A and B, a time-share interest in a unit which has been subjected to a time-share instrument pursuant to § 55-367 may be conveyed prior to substantial completion of that unit if (i) a completion bond has been filed in compliance with subsection B of § 55-79.58:1 and remains in full force and effect until the unit is certified as substantially complete in accordance with subsections A and B and (ii) the settlement agent or title insurance company insuring the time-share estate in the unit certifies to the purchaser in writing, based on information provided by the Common Interest Community Board, that the bond has been filed with the Common Interest Community Board.

        E. When converting all or any portion of any convertible space into one or more units and/or limited common elements, the declarant shall record, with regard to the structure or portion thereof constituting that convertible space, plans showing the location and dimensions of the vertical boundaries of each unit and/or limited common elements formed out of such space. Such plans shall be certified as to their accuracy and compliance with the provisions of this subsection by a licensed architect, licensed engineer or licensed land surveyor.
  ...
  {
    title: `§ 55-79.58:1. Bond to insure completion of improvements.`,
    text:
      `
        A. The declarant shall file with the Common Interest Community Board a bond entered into by the declarant in the sum of 100 percent of the estimated cost of completion, to the extent of the declarant's obligation as stated in the declaration, of all improvements to the common elements of the condominium labeled in the plat or plats as "(NOT YET COMPLETED)" or "(NOT YET BEGUN)" located upon submitted land and which the declarant reasonably believes will not be substantially complete at the time of conveyance of the first condominium unit. Such bond shall be conditioned upon the faithful performance of the declarant's obligation to complete said improvements in strict conformity with the plans and specifications for the same as described in the declaration.

        B. The declarant shall file with the Common Interest Community Board a bond entered into by the declarant in the sum of 100 percent of the estimated cost of completion of a unit in which a time-share interest is conveyed before the unit has been certified as substantially complete in accordance with subsections A and B of § 55-79.58. The bond required by this subsection shall be conditioned upon the faithful performance of the declarant's obligation to complete said improvements in strict conformity with the plans and specifications for the same as described in the declaration.

        C. All bonds required herein shall be executed by a surety company authorized to transact business in the Commonwealth of Virginia or by such other surety as is satisfactory to the Board.
  ...
  {
    title: `§ 55-79.59. Preliminary recordation of plats and plans.`,
    text:
      `
  ...
  {
    title: `§ 55-79.60. Easement for encroachments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.61. Conversion of convertible lands.`,
    text:
      `
        A. The declarant may convert all or any portion of any convertible land into one or more units and/or limited common elements subject to any restrictions and limitations which the condominium instruments may specify. Any such conversion shall be deemed to have occurred at the time of the recordation of appropriate instruments pursuant to subsection B of this section and subsection C of § 55-79.58.

        B. Simultaneously with the recording of plats and plans pursuant to subsection C of § 55-79.58, the declarant shall prepare, execute, and record an amendment to the declaration describing the conversion. Such amendment shall assign an identifying number to each unit formed out of a convertible land and shall reallocate undivided interests in the common elements in accordance with subsection (b) of § 55-79.56. Such amendment shall describe or delineate the limited common elements formed out of the convertible land, showing or designating the unit or units to which each is assigned.
  ...
  {
    title: `§ 55-79.62. Conversion of convertible spaces.`,
    text:
      `
        (a) The declarant may convert all or any portion of any convertible space into one or more units and/or common elements, including, without limitation, limited common elements, subject to any restrictions and limitations which the condominium instruments may specify. Any such conversion shall be deemed to have occurred at the time of the recordation of appropriate instruments pursuant to subsection (b) hereof and subsection B of § 55-79.58.

        (b) Simultaneously with the recording of plats and plans pursuant to subsection E of § 55-79.58, the declarant shall prepare, execute, and record an amendment to the declaration describing the conversion. Such amendment shall assign an identifying number to each unit formed out of a convertible space and shall allocate to each unit a portion of the undivided interest in the common elements appertaining to that space. Such amendment shall describe or delineate the limited common elements formed out of the convertible space, showing or designating the unit or units to which each is assigned.

        (c) If all or any portion of any convertible space is converted into one or more units in accordance with this section, the declarant shall prepare and execute, and record simultaneously with the amendment to the declaration, an amendment to the bylaws. The amendment to the bylaws shall reallocate votes in the unit owners' association, rights to future common profits, and liabilities for future common expenses not specially assessed, all as in the case of the subdivision of a unit in accordance with subsection D of § 55-79.70.
  ...
  {
    title: `§ 55-79.63. Expansion of condominium.`,
    text:
      `
  ...
  {
    title: `§ 55-79.64. Contraction of condominium.`,
    text:
      `
  ...
  {
    title: `§ 55-79.65. Easement to facilitate conversion and expansion.`,
    text:
      `
  ...
  {
    title: `§ 55-79.66. Easement to facilitate sales.`,
    text:
      `
  ...
  {
    title: `§ 55-79.68. Alterations within units.`,
    text:
      `
  ...
  {
    title: `§ 55-79.69. Relocation of boundaries between units.`,
    text:
      `
        ...
        F. When appropriate instruments in accordance with the preceding subsections hereof have been prepared, executed, and acknowledged, they shall be recorded by an officer of the unit owners' association following payment by the unit owners of the units involved of all reasonable costs for the preparation, acknowledgment and recordation thereof. Said instruments shall become effective when executed by the unit owners of the units involved and recorded, and the recordation thereof shall be conclusive evidence that the relocation of boundaries thus effectuated did not violate any restrictions or limitations specified by the condominium instruments and that any reallocations made pursuant to subsections C and D were reasonable.
  ...
  {
    title: `§ 55-79.70. Subdivision of units.`,
    text:
      `
        ...
        F. When appropriate instruments in accordance with the preceding subsections hereof have been prepared, executed, and acknowledged, they shall be recorded by an officer of the unit owners' association following payment by the subdivider of all reasonable costs for the preparation, acknowledgment and recordation thereof. Said instruments shall become effective when executed by the subdivider and recorded, and the recordation thereof shall be conclusive evidence that the subdivision thus effectuated did not violate any restrictions or limitations specified by the condominium instruments and that any reallocations made pursuant to subsections C and D were reasonable.
  ...
  {
    title: `§ 55-79.71. Amendment of condominium instruments.`,
    text:
      `
  ...
  {
    title: `§ 55-79.71:1. Use of technology.`,
    text:
      `
  ...
  {
    title: `§ 55-79.71:2. Merger or consolidation of condominiums; procedure.`,
    text:
      `
  ...
  {
    title: `§ 55-79.72:1. Termination of condominium.`,
    text:
      `
        A. If there is no unit owner other than the declarant, the declarant may unilaterally terminate the condominium. An instrument terminating a condominium shall become effective upon recordation thereof if the termination instrument has been signed by the declarant. But this section shall not be construed to nullify, limit, or otherwise affect the validity or enforceability of any agreement renouncing or to renounce, in whole or in part, the right hereby conferred.
        ...
        C. Agreement of the required majority of unit owners to termination of the condominium shall be evidenced by their execution of a termination agreement, or ratifications thereof, and the same shall become effective when a copy of the termination agreement is recorded together with a certification, signed by the principal officer of the unit owners' association or by such other officer or officers as the condominium instruments may specify, that the requisite majority of the unit owners signed the termination agreement or ratifications thereof. Unless the termination agreement otherwise provides, prior to recordation of the termination agreement, a unit owner's prior agreement to terminate the condominium may be revoked only with the approval of unit owners of units to which a majority of the votes in the unit owners' association appertain. The termination agreement shall specify a date after which the termination agreement shall be void if the termination agreement is not recorded. For the purposes of this section, an instrument terminating a condominium and any ratification thereof shall be deemed a condominium instrument subject to the provisions of § 55-79.49.

        D. In the case of a condominium that contains only units having horizontal boundaries described in the condominium instruments, a termination agreement may provide that all the common elements and units of the condominium shall be sold following termination. If, pursuant to the termination agreement, any property in the condominium is sold following termination, the termination agreement shall set forth the minimum terms of the sale.

        E. In the case of a condominium that contains any units not having horizontal boundaries described in the condominium instruments, a termination agreement may provide for sale of the common elements. The termination agreement may not require that the units be sold following termination, unless the condominium instruments as originally recorded provide otherwise or all the unit owners consent to the sale. In the case of a master condominium that contains a unit which is a part of another condominium, a termination agreement for the master condominium shall not terminate the other condominium.

        F. On behalf of the unit owners, the unit owners' association may contract for the disposition of property in the condominium, but the contract shall not be binding on the unit owners until approved pursuant to subsections B and C of this section. If the termination agreement requires that any property in the condominium be sold following termination, title to the property, upon termination, shall vest in the unit owners' association as trustee for the holders of all interest in the units. Thereafter, the unit owners' association shall have powers necessary and appropriate to effect the sale. Until the same has been concluded and the proceeds have been distributed, the unit owners' association shall continue in existence with all the powers the unit owners' association had before termination. Proceeds of the sale shall be distributed to unit owners and lien holders as their interests may appear, in proportion to the respective interests of the unit owners as provided in subsection I of this section. Unless otherwise specified in the termination agreement, for as long as the unit owners' association holds title to the property, each unit owner or his successor in interest shall have an exclusive right to occupancy of the portion of the property that formerly constituted his unit. During the period of occupancy by the unit owner or his successor in interest, each unit owner or his successor in interest shall remain liable for any assessment or other obligation imposed on the unit owner by this chapter or the condominium instruments.

        G. If the property that constitutes the condominium is not sold following termination, title to the common elements and, in the case of a condominium containing only units that have horizontal boundaries described in the condominium instruments, title to all the property in the condominium shall vest in the unit owners, upon termination, as tenants in common in proportion to the unit owners' respective interests as provided in subsection I of this section. Any liens on the units shall shift accordingly. While the tenancy in common exists, each unit owner or his successor in interest shall have the exclusive right to occupancy of the portion of the property that formerly constituted the unit owner's unit.
        ...
        1. Except as provided in subdivision 2, the respective interests of the unit owners shall be the fair market values of their units, limited common elements, and common element interests immediately before the termination, as determined by one or more independent appraisers selected by the unit owners' association. The decision of the independent appraisers shall be distributed to the unit owners and become final unless disapproved within thirty days after distribution by unit owners of units to which one-quarter of the votes in the unit owners' association appertain. The proportion of any unit owner's interest to the interest of all unit owners is determined by dividing the fair market value of that unit owner's unit and common element interest by the total fair market values of all the units and their common element interests.

        2. If any unit or limited common element is destroyed to the extent that an appraisal of the fair market value thereof before destruction cannot be made, the interests of all unit owners are the unit owners' respective common element interests immediately before the termination.
  ...
  {
    title: `§ 55-79.72:2. Rights of mortgagees.`,
    text:
      `
  ...
  {
    title: `§ 55-79.72:3. Statement of unit owner rights.`,
    text:
      `
        Every unit owner who is a member in good standing of a unit owners' association shall have the following rights:

        1. The right of access to all books and records kept by or on behalf of the unit owners' association according to and subject to the provisions of § 55-79.74:1, including records of all financial transactions;
        ...
        3. The right to have notice of any meeting of the executive organ, to make a record of such meetings by audio or visual means, and to participate in such meeting in accordance with the provisions of § 55-79.75;

        4. The right to have (i) notice of any proceeding conducted by the executive organ or other tribunal specified in the condominium instruments against the unit owner to enforce any rule or regulation of the unit owners' association and (ii) the opportunity to be heard and represented by counsel at the proceeding, as provided in § 55-79.80:2, and the right of due process in the conduct of that hearing; and

        5. The right to serve on the executive organ if duly elected and a member in good standing of the unit owners' association, except to the extent that the condominium instruments provide otherwise.
